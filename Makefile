...
SORT = check_sort_status.c top3_sort.c top3_sort_ops.c sort_ops.c count_sorted.c print_sort_ops.c reverse_sort_ops.c sort_utils.c naive_radix_sort.c compress_cordinates.c
